...
#export TEST_LDFLAGS += -O2 -m32 -mios-simulator-version-min=5.0 -L/Users/troy/Projects/CelltrustTrunk/Pods/OpenSSL//lib -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator8.4.sdk -framework AudioToolbox -framework Foundation -Lyes/lib -lm -lpthread  -framework CoreAudio -framework CoreFoundation -framework AudioToolbox -framework CFNetwork -framework UIKit -framework UIKit -framework OpenGLES -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia
